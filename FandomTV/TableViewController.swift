...
//  FandomTV
//
//  Created by Simon Narang on 4/10/16.
...
class TableViewController: UITableViewController {
    ...
    var fakes = ["will", "simon", "claire", "varun", "ethan", "bobsherwood", "clairekiren", "god"]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = "hi from \(self.dataArray[indexPath.row])"
